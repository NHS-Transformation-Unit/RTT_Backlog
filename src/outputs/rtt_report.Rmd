...
```
Looking at *Treatment Functions* demonstrates that almost all services have seen an increase in the backlog since the pandemic. However, there is considerable difference in the scale of this increase. _Figure 3_ shows the number of Incomplete Pathways for seven key services since April 2011:
...
At the start of the pandemic there was a sudden and sharp rise in waiting times for patients on an Incomplete Pathway. This was driven by a significant drop in referrals into secondary care during lockdown. Since mid-2020 waiting times continued deteriorate. The median waiting time has now risen to `r rtt_quantiles_text[[1,4]]` weeks. The upper quartile waiting time currently stands at `r rtt_quantiles_text[[1,5]]` weeks and the 90th percentile is at `r rtt_quantiles_text[[1,6]]`.
...
The same pattern seen nationally can occurs across each of the NHS England regions as shown in _Figure 8_ below:
